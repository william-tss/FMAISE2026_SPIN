...
/*** From source: tsp4_optimized.pml ***/
...
short src_ln0 [] = {
	  0,  20,  29,  29,  30,  28,  33,  34, 
	 34,  34,  35,  35,  35,  36,  36,  36, 
	 33,  38,  22,  41,  45,  45,  46,  44, 
	 49,  50,  50,  50,  51,  51,  51,  52, 
	 52,  52,  49,  54,  40,  57,  61,  61, 
	 62,  60,  65,  66,  66,  66,  67,  67, 
	 67,  68,  68,  68,  65,  70,  56,  73, 
	 77,  77,  78,  76,  81,  82,  82,  82, 
	 83,  83,  83,  84,  84,  84,  81,  86, 
	 72,  94, 108,   0, };
S_F_MAP src_file0 [] = {
	{ "-", 0, 0 },
	{ "tsp4_optimized.pml", 1, 74 },
	{ "-", 75, 76 }
};
uchar reached0 [] = {
	  0,   0,   1,   1,   1,   1,   1,   1, 
...
struct {
	...
	{ "c_code5", "        if (now.cost < min_cost) {\n            min_cost = now.cost;\n            printf(\"> min cost now: %d\n\", min_cost);\n\n\n            putrail();\n\n\n\n            Nr_Trails--;\n        }\n    " },
	{ "c_code4", " now.cost >= min_cost " },
	{ "c_code3", " now.cost >= min_cost " },
	{ "c_code2", " now.cost >= min_cost " },
	{ "c_code1", " now.cost >= min_cost " },
	{ (char *) 0, "" }
};

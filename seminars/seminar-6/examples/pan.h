...
#define PanSource	"deadlock.plcCommented.pml"
...
#define _nstates12	59	/* :init: */
#define minseq12	612
#define maxseq12	669
#define _endstate12	58

#define _nstates11	23	/* Advance */
#define minseq11	590
#define maxseq11	611
#define _endstate11	22

#define _nstates10	184	/* Control */
#define minseq10	407
#define maxseq10	589
#define _endstate10	183

#define _nstates9	46	/* Pump2 */
#define minseq9	362
#define maxseq9	406
#define _endstate9	45

#define _nstates8	46	/* Pump1 */
#define minseq8	317
#define maxseq8	361
#define _endstate8	45

#define _nstates7	31	/* Cool7 */
#define minseq7	287
#define maxseq7	316
#define _endstate7	30

#define _nstates6	31	/* Cool6 */
#define minseq6	257
#define maxseq6	286
#define _endstate6	30

#define _nstates5	44	/* B5toB7 */
#define minseq5	214
#define maxseq5	256
#define _endstate5	43

#define _nstates4	54	/* Heat5 */
#define minseq4	161
#define maxseq4	213
#define _endstate4	53

#define _nstates3	38	/* B4toB5 */
#define minseq3	124
#define maxseq3	160
#define _endstate3	37

#define _nstates2	43	/* B3toB4 */
#define minseq2	82
#define maxseq2	123
#define _endstate2	42

#define _nstates1	42	/* B2toB3 */
#define minseq1	41
#define maxseq1	81
#define _endstate1	41

#define _nstates0	42	/* B1toB3 */
#define minseq0	0
#define maxseq0	40
#define _endstate0	41
...
#define Pinit	((P12 *)_this)
typedef struct P12 { /* :init: */
...
#define PAdvance	((P11 *)_this)
typedef struct P11 { /* Advance */
	unsigned _pid : 8;  /* 0..255 */
	unsigned _t   : 5; /* proctype */
	unsigned _p   : 9; /* state    */
#ifdef HAS_PRIORITY
...
#define PControl	((P10 *)_this)
typedef struct P10 { /* Control */
	unsigned _pid : 8;  /* 0..255 */
	unsigned _t   : 5; /* proctype */
	unsigned _p   : 9; /* state    */
#ifdef HAS_PRIORITY
...
#define Air10	(sizeof(P10) - Offsetof(P10, last) - 1*sizeof(int))

#define PPump2	((P9 *)_this)
typedef struct P9 { /* Pump2 */
	unsigned _pid : 8;  /* 0..255 */
	unsigned _t   : 5; /* proctype */
	unsigned _p   : 9; /* state    */
#ifdef HAS_PRIORITY
...
#define PPump1	((P8 *)_this)
typedef struct P8 { /* Pump1 */
	unsigned _pid : 8;  /* 0..255 */
	unsigned _t   : 5; /* proctype */
	unsigned _p   : 9; /* state    */
#ifdef HAS_PRIORITY
...
#define PCool7	((P7 *)_this)
typedef struct P7 { /* Cool7 */
	unsigned _pid : 8;  /* 0..255 */
	unsigned _t   : 5; /* proctype */
	unsigned _p   : 9; /* state    */
#ifdef HAS_PRIORITY
...
#define PCool6	((P6 *)_this)
typedef struct P6 { /* Cool6 */
	unsigned _pid : 8;  /* 0..255 */
	unsigned _t   : 5; /* proctype */
	unsigned _p   : 9; /* state    */
#ifdef HAS_PRIORITY
...
#define PB5toB7	((P5 *)_this)
typedef struct P5 { /* B5toB7 */
	unsigned _pid : 8;  /* 0..255 */
	unsigned _t   : 5; /* proctype */
	unsigned _p   : 9; /* state    */
#ifdef HAS_PRIORITY
...
#define PHeat5	((P4 *)_this)
typedef struct P4 { /* Heat5 */
	unsigned _pid : 8;  /* 0..255 */
	unsigned _t   : 5; /* proctype */
	unsigned _p   : 9; /* state    */
#ifdef HAS_PRIORITY
...
#define PB4toB5	((P3 *)_this)
typedef struct P3 { /* B4toB5 */
	unsigned _pid : 8;  /* 0..255 */
	unsigned _t   : 5; /* proctype */
	unsigned _p   : 9; /* state    */
#ifdef HAS_PRIORITY
...
#define PB3toB4	((P2 *)_this)
typedef struct P2 { /* B3toB4 */
	unsigned _pid : 8;  /* 0..255 */
	unsigned _t   : 5; /* proctype */
	unsigned _p   : 9; /* state    */
#ifdef HAS_PRIORITY
...
#define PB2toB3	((P1 *)_this)
typedef struct P1 { /* B2toB3 */
	unsigned _pid : 8;  /* 0..255 */
	unsigned _t   : 5; /* proctype */
	unsigned _p   : 9; /* state    */
#ifdef HAS_PRIORITY
...
#define PB1toB3	((P0 *)_this)
typedef struct P0 { /* B1toB3 */
	unsigned _pid : 8;  /* 0..255 */
	unsigned _t   : 5; /* proctype */
	unsigned _p   : 9; /* state    */
#ifdef HAS_PRIORITY
